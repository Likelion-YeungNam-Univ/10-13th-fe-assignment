  ...
  const fetchPosts = async () => {
    try {
      const response = await axios.get(
        `https://api.themoviedb.org/3/discover/movie?api_key=5bfdfd938b524a65881c8c54be388cb5&with_genres=35`
      );
      setComedies(response.data.results);
    } catch (error) {
      setError("데이터 로딩 실패");
